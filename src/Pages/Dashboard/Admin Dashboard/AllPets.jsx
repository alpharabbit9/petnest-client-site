...
const AllPets = () => {
    ...
    const fetchUsers = async () => {
        try {
            setLoading(true);
            const response = await fetch('https://petnest-server-site.vercel.app/pets');
            if (!response.ok) {
    ...
    const HandleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.delete(`https://petnest-server-site.vercel.app/pets/${id}`)
                    .then(res => {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-r from-blue-800 via-teal-600 to-cyan-700 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <div className="text-white text-lg">Loading pets...</div>
                </div>
            </div>
        );
    }
            ...
            >
                ...
                <motion.div variants={itemVariants} className="text-center mb-8">
                    ...
                    <p className="text-emerald-100 text-lg">
                        Keep track of your furry friends and their details with ease.
                    </p>
                </motion.div>
                ...
                >
                    <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 text-white/90">
                            ...
                            <span className="font-semibold">{filteredUsers.length} pets</span>
                        </div>
                    </div>
                </motion.div>
